...
def main():
    ...
    # =========================================================
    # 1. 造输入
    # 注: 这里用纯随机张量, 不像 01/02/03 那样从 tokens 查 embedding。
    #     因为本脚本重点是"Block 不改变形状 + LayerNorm 让激活稳定",
    #     不是 attention 模式, 所以输入的具体语义不重要。
    #     如果想看完整 token → block → 输出 的流程, 见 05_mini_gpt.py。
    # =========================================================
    B, T, d_model = 2, 8, 32
    n_heads = 4
